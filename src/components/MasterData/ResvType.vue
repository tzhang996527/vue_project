  ...
  <div>
    ...
    >
      <el-form :rules="rules" ref="ruleForm" :model="form" label-width="80px" class="demo-ruleForm">
        <el-row>
          <el-col :span="18">
            <el-form-item label="预定类型" prop="name" style>
              <el-col :span="12">
                <el-input maxlength="10" v-model="form.resvType"></el-input>
              </el-col>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <el-col :span="18">
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          <el-form-item label="预定类型">
            <el-input v-model="formInline.resvType" placeholder="预定类型"></el-input>
          </el-form-item>
    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="tableData" style="width: 100%" stripe>
          ...
          <el-table-column label="预定类型" sortable width="180">
            <template slot-scope="scope">
              <span style="margin-left: 10px">{{ scope.row.resvType }}</span>
            </template>
          </el-table-column>
...
export default {
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "请输入预定类型", trigger: "blur" },
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$axios({
        url: "/api/v1/resvType/" + row.resvType,
        method: "delete",
        headers: {
